...
def simulate_RW_MLlr_adversarial(x, eps, unchosen, reward_alpha, ML_alpha_mean, ML_alpha_std, T, Q_int, ML_mean_int, ML_std_int, scale, update, reward_stable, reward_volatile):
    ...
    #scale              --->        scale with which ML-parameter gets transformed to learning rate in a logit transformation
    ...
    #ML_mean_int = (1/scale)*np.log(lr_mean_int/(1-lr_mean_int))
    #ML_std_int = (1/scale)*np.log(lr_std_int/(1-lr_std_int))
...
#meta-learning goes through parameter ML which is transformed to learning rate with a logit transformation
#rewards are baselined
def simulate_RW_MLlr_stable(x, eps, unchosen, reward_alpha, ML_alpha_mean, ML_alpha_std, T, Q_int, ML_mean_int, ML_std_int, scale, update, reward_stable, reward_volatile):
    #eps                --->        epsilon; probability to choose randomly
    #unchosen           --->        the added value to unchosen option values
    #reward_alpha       --->        learning rate of baseline reward
    #ML_alpha_mean      --->        learning rate for mean of meta-learning parameter
...
#meta-learning goes through parameter ML which is transformed to learning rate with a logit transformation
#rewards are baselined
def simulate_RW_MLlr_volatile(x, eps, unchosen, reward_alpha, ML_alpha_mean, ML_alpha_std, T, Q_int, ML_mean_int, ML_std_int, scale, update, reward_stable, reward_volatile):
    #eps                --->        epsilon; probability to choose randomly
    #unchosen           --->        the added value to unchosen option values
    #reward_alpha       --->        learning rate of baseline reward
    #ML_alpha_mean      --->        learning rate for mean of meta-learning parameter
...
for sim in range(amount_of_sim):
    k, r, Q_k_stored, LR_var, LR_var_mean, LR_var_std, ML_stored, ML_mean_stored, ML_std_stored = simulate_RW_MLlr_adversarial(x=x, eps=eps, unchosen=unchosen, reward_alpha= reward_alpha, ML_alpha_mean = ML_alpha_mean, ML_alpha_std=ML_alpha_std, T=T, Q_int=Q_int, ML_mean_int=MLlr_mean_int, ML_std_int=ML_std_int, scale=1, update = 10, reward_stable=reward_stable, reward_volatile=reward_volatile)
...
#simulation:
for sim in range(amount_of_sim):
    k, r, Q_k_stored, LR_sta, LR_sta_mean, LR_sta_std, ML_stored, ML_mean_stored, ML_std_stored = simulate_RW_MLlr_stable(x=x, eps=eps, unchosen=unchosen, reward_alpha= reward_alpha, ML_alpha_mean = ML_alpha_mean, ML_alpha_std=ML_alpha_std, T=T, Q_int=Q_int, ML_mean_int=MLlr_mean_int, ML_std_int=ML_std_int, scale=1, update = 10, reward_stable=reward_stable, reward_volatile=reward_volatile)
...
for sim in range(amount_of_sim):
    k, r, Q_k_stored, LR_vol, LR_vol_mean, LR_vol_std, ML_stored, ML_mean_stored, ML_std_stored = simulate_RW_MLlr_volatile(x=x, eps=eps, unchosen=unchosen, reward_alpha= reward_alpha, ML_alpha_mean = ML_alpha_mean, ML_alpha_std=ML_alpha_std, T=T, Q_int=Q_int, ML_mean_int=MLlr_mean_int, ML_std_int=ML_std_int, scale=1, update = 10, reward_stable=reward_stable, reward_volatile=reward_volatile)
...
epsilonsta, = ax12.plot(time, lr_sta_end, label=f'stable environment', color='darkcyan')
epsilonvol, = ax12.plot(time, lr_vol_end, label=f'volatile environment', color='darkorange')
epsilonvar, = ax12.plot(time, lr_var_end, label=f'variable environment', color='forestgreen')
...
title_excel = os.path.join(save_dir, f'sim{sim_nr}av_rewards_LR.xlsx')
...
title_excel = os.path.join(save_dir, f'sim{sim_nr}av_lr.xlsx')
